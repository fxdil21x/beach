...
export const bulkDeleteResidentRecords = (ids) => api.post('/master/resident-records/bulk-delete', { ids });
export const purgeAllResidentData = () => api.post('/master/resident-records/purge-all');
