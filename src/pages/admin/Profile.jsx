    ...
    <div className="flex h-screen h-[100dvh] flex-col overflow-hidden bg-gray-50">
      ...
      <main className="flex-1 min-h-0 overflow-y-auto space-y-4 px-4 py-6">
        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-base font-semibold text-slate-800">{t('profile.language') || 'Language'}</p>
            <p className="text-xs text-slate-500">{t('profile.selectLanguage') || 'Select your preferred language'}</p>
          </div>
          <LanguageSwitcher />
        </div>
