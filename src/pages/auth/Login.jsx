...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-blue-50/80 via-slate-50 to-slate-100 px-4 py-8 text-slate-900">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 sm:p-8 shadow-xl border border-slate-100 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" disabled={loading} className="w-full py-3.5 text-base font-bold shadow-md">
            {loading ? t('common.loading', 'Signing in...') : t('auth.loginButton', 'Sign In')}
          </Button>
        </form>
