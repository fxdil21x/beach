...
export default function ScanResult({ result, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-full w-full flex-col items-center justify-center px-4 py-8 pb-20 sm:py-12">
        {/* status icon ring */}
        <div
          style={{
        ...
        {resident && (
          <div style={{
            marginTop: 24, width: '100%', maxWidth: 380, borderRadius: 20,
            ...
            <div style={{ padding: '20px 20px 16px' }}>
              ...
              <div className="flex items-center gap-4" style={{ marginBottom: 18 }}>
                ...
                <div className="min-w-0 flex-1">
                  <p style={{ fontSize: 18, fontWeight: 700, color: '#111', lineHeight: 1.2, wordBreak: 'break-word' }}>{resident.name}</p>
        ...
        {result?.visitorEntry && (
          <div style={{
            marginTop: 20, width: '100%', maxWidth: 380, borderRadius: 20,
            background: 'rgba(255,255,255,0.97)', boxShadow: '0 20px 60px rgba(0,0,0,0.35)', overflow: 'hidden',
          }}>
            {/* header */}
            <div style={{
        ...
        <button
          ...
          onClick={onClose}
          style={{
            marginTop: 24, width: '100%', maxWidth: 380, padding: '14px 24px', borderRadius: 14,
            background: 'rgba(255,255,255,0.18)', color: '#fff', fontSize: 16, fontWeight: 700,
            border: '1px solid rgba(255,255,255,0.3)', backdropFilter: 'blur(10px)',
            boxShadow: '0 8px 24px rgba(0,0,0,0.2)',
            cursor: 'pointer', letterSpacing: '0.5px', transition: 'all 0.2s ease',
          }}
          onMouseEnter={e => {
